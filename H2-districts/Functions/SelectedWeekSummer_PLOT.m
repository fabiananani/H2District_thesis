function [] = SelectedWeekSummer_PLOT(linew,font,Time,start,finish,P_PV_opt,P_FC_opt,P_imp_opt,P_exp_opt,P_FC_nom,SOC_opt,P_load,FC_On_opt)
...
% title ('Power trend over a Selected Week in Summer')
...
set(gca, 'FontSize', font-4); % Set axis font size and font name
set(findall(gcf, 'Type', 'line'), 'LineWidth', 1.2); % Set line width
title ('SOC trend over a Selected Week in Summer')
