...
%% INPUT PARAMETERS
 ...
 % Costs and Efficencies 
    ...
    UP_FC        = 950;%3000          % Unit price FC [EUR/kW]
...
% OPERATIONAL decision variables
    ...
    sizingprob.Constraints.PowerFC3C              = P_FC_On >= S_FC - S_FC_max.*(ones(nHours,1) - delta_On);
    ...
    sizingprob.Constraints.massflow                  = m_flow_H2 == P_FC./eff_FC./HHV.*3600 + Const*w_hours;
...
% grid on
% figure
% plot(tt,Const*w_hours_opt(startS:finishS))
