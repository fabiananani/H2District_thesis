...
for i = 2:nHours
    ...
    % fuel_cons(i) = (1 - ((0.02 / (P_FC_max * nH_yearly)) * P_FC_opt(i) * FC_On_opt(i))) * fuel_cons(i-1); % [kWh/Nm3]
end
...
%% PLOT MASS FLOW RATE 
figure
plot(Time(100:268),flow_H2_nom(100:268))
hold on
plot(Time(100:268),flow_H2(100:268))
legend('no deg','deg')